...
public class Satellite {
  ...
  private String[] powerTypeSel = {"battery", "solar", "nuclear"};
  ...
  public void MassRadsel() { // Method for selecting Mass and Radius through orbit type (oType)
    switch (oType) {
      case "Earth":
        radius = ERADIUS;
        mass = EMASS;
