 ...
 * swap methods once at the beginning and inside of the method.  "After swap" also printed
...
public class CH5Demo {
 static public UserPrompts mylanguage = new EnglishLanguage();
 ...
 public static void main(String[] args) {
   ...
   for (int i = 0; i < intlist.length; i++) intlist[i] = rand.nextInt(101);
   ...
   while (!done) {
    ...
    switch (selection) {
     ...
     case 3: // change to second or third language
			switch(mylanguage.languageMenu()) {
      case 1:
				mylanguage = new EnglishLanguage();
				break;
      case 2:
      	mylanguage = new RomanianLanguage();
				break;
      case 3:
      	mylanguage = new FrenchLanguage();
				break;
			default:
